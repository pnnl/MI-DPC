...
fig1.savefig(f'experiment_plot.svg', bbox_inches='tight', pad_inches=0.05,transparent=True)
fig1.savefig(f'experiment_plot.eps', bbox_inches='tight', pad_inches=0.05,transparent=True)
